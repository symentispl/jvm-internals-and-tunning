...
[source,java,indent=0]
----
include::{sourcedir}/mapreduce-framework/src/main/java/pl/symentis/mapreduce/SequentialMapReduce.java[lines=60..67]
----
...
[source,java,indent=0]
----
include::{sourcedir}/mapreduce-wordcount/src/main/java/pl/symentis/wordcount/WordCount.java[lines=66..77]
----
...
[source,java,indent=0]
----
include::{sourcedir}/mapreduce-wordcount/src/main/java/pl/symentis/wordcount/WordCount.java[lines=79..97]
----
...
[source,java,indent=0]
----
include::{sourcedir}/mapreduce-wordcount/src/main/java/pl/symentis/wordcount/stopwords/NonThreadLocalStopwords.java[lines=29..32]
----
...
[source,java,indent=0]
----
include::{sourcedir}/mapreduce-framework/src/main/java/pl/symentis/mapreduce/mapper/HashMapOutput.java[lines=12..21]
----
...
[source,java,indent=0]
----
include::{sourcedir}/mapreduce-framework/src/main/java/pl/symentis/mapreduce/ParallelMapReduce.java[lines=45..71]
----
...
[format="csv", options="header"]
|===
(threadPoolMaxSize),   Mode,  Score, Units
                  4,  thrpt,  3.930, ops/s
                  8,  thrpt,  3.915, ops/s
                 16,  thrpt,  2.516, ops/s
                 32,  thrpt,  2.618, ops/s
|===
...
`BlockingQueue` in `ThreadPoolExecutor`

`ConcurrentHashMap`

=== batching

send bigger chunks of data into `ThreadPoolExecutor`
...
[source,java,indent=0]
----
include::{sourcedir}/mapreduce-framework/src/main/java/pl/symentis/mapreduce/BatchingParallelMapReduce.java[lines=63..86]
----
...
[source,java,indent=0]
----
include::{sourcedir}/mapreduce-framework/src/main/java/pl/symentis/mapreduce/BatchingParallelMapReduce.java[lines=144..151]
----
...
[source,java,indent=0]
----
include::{sourcedir}/mapreduce-framework/src/main/java/pl/symentis/mapreduce/BatchingParallelMapReduce.java[lines=105..117]
----
...
image::https://media.giphy.com/media/zSZogXiRS2zjG/giphy.gif[background,size=contain]
...
[source,java,indent=0]
----
include::{sourcedir}/mapreduce-framework/src/main/java/pl/symentis/mapreduce/ForkJoinMapReduce.java[lines=50..78]
----
...
we he blocking operation in task +
(use ManagedBlocker)

use `CountedCompleter` for task coordination
...
image::https://media.giphy.com/media/26AHC0kdj8IeLkmBy/giphy.gif[background]
