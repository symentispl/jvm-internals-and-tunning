...
[source,java,indent=0]
----
include::{sourcedir}/mapreduce-wordcount/src/main/java/pl/symentis/wordcount/WordCount.java[lines=97..103]
----
...
[source,java,indent=0]
----
include::{sourcedir}/mapreduce-wordcount/src/main/java/pl/symentis/wordcount/WordCount.java[lines=73..84]
----
